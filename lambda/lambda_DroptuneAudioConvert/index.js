...
exports.handler = async (event, context) => {
  ...
  if(extension == 'wav') {
    ...
    ffmpegCommand = "ffmpeg -i /tmp/" +filename + "." +extension + " -ab 192k -acodec aac -strict experimental /tmp/" + filename + ".aac"

  }  else if (extension == 'm4a') {

    ffmpegCommand = "ffmpeg -i /tmp/" + filename + "." + extension + " -acodec copy /tmp/" + filename + ".aac"

  } else if (extension == 'mp3') {

    ffmpegCommand = "ffmpeg -i /tmp/" + filename + "." + extension + " -c:a aac -b:a 192k /tmp/" + filename + ".aac"
